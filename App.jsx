...
const NewRentForm = ({ inventory, rents, setRents, draftItemId, setDraftItemId, setActiveTab }) => {
      ...
      <div className="bg-white rounded-3xl p-6 shadow-xl relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input required type="tel" maxLength={10} minLength={10} pattern="\d{10}" title="Please enter exactly 10 digits" className="w-full border border-gray-200 rounded-xl px-4 py-3 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-[#4A8B9D] focus:border-transparent outline-none transition-all" 
  ...
  // ---------- STOCK LIST LOGIC ----------
const StockTab = ({ inventory, setInventory, setDraftItemId, setActiveTab }) => {
...
const AnalyticsTab = ({ rents, inventory }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1A2B3C] to-[#0A3E3C] font-sans selection:bg-[#4A8B9D]/30 relative max-w-md mx-auto shadow-2xl overflow-x-hidden">
      ...
      <main className="min-h-[calc(100vh-140px)]">
        ...
        {activeTab === 'New' && <NewRentForm inventory={inventory} rents={rents} setRents={setRents} draftItemId={draftItemId} setDraftItemId={setDraftItemId} setActiveTab={setActiveTab} />}
        {activeTab === 'Stock' && <StockTab inventory={inventory} setInventory={setInventory} setDraftItemId={setDraftItemId} setActiveTab={setActiveTab} />}
        {activeTab === 'Reports' && <AnalyticsTab rents={rents} inventory={inventory} />}
      </main>
